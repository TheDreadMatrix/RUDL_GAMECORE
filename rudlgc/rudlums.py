...
class Evalent:
    ...
    MOUSE_DOWN = sdl2.SDL_MOUSEBUTTONDOWN
    MOUSE_UP = sdl2.SDL_MOUSEBUTTONUP
    MOUSE_MOVE = sdl2.SDL_MOUSEMOTION

    MOUSE_WHEEL = sdl2.SDL_MOUSEWHEEL
    MOUSE_ENTER = sdl2.SDL_WINDOWEVENT_ENTER
    MOUSE_LEAVE = sdl2.SDL_WINDOWEVENT_LEAVE

    FINGER_DOWN = sdl2.SDL_FINGERDOWN
    FINGER_UP = sdl2.SDL_FINGERUP
    FINGER_MOVE = sdl2.SDL_FINGERMOTION

    TEXT_INPUT = sdl2.SDL_TEXTINPUT
    TEXT_EDITING = sdl2.SDL_TEXTEDITING

    WINDOW_RESIZED = sdl2.SDL_WINDOWEVENT
    WINDOW_LOST_FOCUS = sdl2.SDL_WINDOWEVENT_FOCUS_LOST
    WINDOW_GAIN_FOCUS = sdl2.SDL_WINDOWEVENT_FOCUS_GAINED

    WINDOW_MINIMILIZED = sdl2.SDL_WINDOWEVENT_MINIMIZED
    WINDOW_MAXIMILIZED = sdl2.SDL_WINDOWEVENT_MAXIMIZED
    WINDOW_RESTORED = sdl2.SDL_WINDOWEVENT_RESTORED